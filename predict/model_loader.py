...
from bothModelLSTM import testModel
import cv2
import numpy as np
...
class ModelLoader():
    ...
    def __init__(self, model_file='bothModelLSTMpre.pkl'):
        # You should 
    ...
    def get_anchors(self):
        ...
        #    anchors = f.readline()
        anchors = "10,9, 21,46, 35,50, 43,18, 45,20, 47,19, 49,24, 51,21, 73,28, 103,30"
    ...
    def get_bounding_boxes(self, samples):
        ...
        self.count += 1
        if self.test_flag != 'detection' or self.count == self.model.NUM_SAMPLE_PER_SCENE:
            self.count = 0
    ...
    def get_binary_road_map(self, samples):
        ...
        self.count += 1
        if self.test_flag != 'roadimage' or self.count == self.model.NUM_SAMPLE_PER_SCENE:
            self.count = 0
            self.model.removeBuffer()
